...
awful.util.tagnames = { "➊ www", "➋ office", "➌ audio", "➍ stuff 1", "➎ stuff 2", "➏ stuff 3" }
--awful.util.tagnames = {  "➊", "➋", "➌", "➍", "➎", "➏", "➐", "➑", "➒" }
...
globalkeys = mytable.join(
    ...
    -- Menu
    --awful.key({ modkey,   shift        }, "s", function () awful.util.mymainmenu:show() end,
    ...
    awful.key({ modkey, }, "w", function ()
        os.execute(string.format("rofi -show window -show-icons"
        ))
        end,
        {description = "show rofi clients", group = "launcher"}),
...
clientkeys = mytable.join(
	...
	awful.key({ modkey},"]", function () awful.util.spawn_with_shell("xrandr --output LVDS-1 --off --output VGA-1 --mode 1920x1080 --pos 1920x0 --rotate normal --output HDMI-1 --off --output DP-1 --off --output HDMI-2 --off --output HDMI-3 --off --output DP-2 --primary --mode 1920x1080 --pos 0x0 --rotate normal --output DP-3 --off") end),
	awful.key({ modkey},"[", function () awful.util.spawn_with_shell("xrandr --output LVDS-1 --mode 1366x768 --pos 0x0 --rotate normal --output VGA-1 --off --output HDMI-1 --off --output DP-1 --off --output HDMI-2 --off --output HDMI-3 --off --output DP-2 --off --output DP-3 --off") end),
...
--beautiful.notification_bg = "#ff8c00"
--beautiful.notification_fg = "#ff8c00"

awful.util.spawn_with_shell("picom --experimental-backends")
--awful.util.spawn_with_shell("thinkfan -n")
awful.spawn.with_shell("/home/ace/.config/awesome/autostart.sh")
